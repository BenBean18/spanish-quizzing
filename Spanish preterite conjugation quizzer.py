...
conjugaciones_ar = {"yo": "-é",
                    "tú": "-aste",
                    "usted/él/ella": "-ó",
                    "nosotros(as)": "-amos",
                    "vosotras(os)": "-asteis",
                    "ustedes/ellos(as)": "-aron"}

conjugaciones_er_o_ir = {"yo": "-í",
                         "tú": "-iste",
                         "usted/él/ella": "-ió",
                         "nosotros(as)": "-imos",
                         "vosotras(os)": "-isteis",
                         "ustedes/ellos(as)": "-ieron"}
...
while True:
    ...
    respuesta = input(f"\033[33mThe preterite conjugation for [verb]{ending}, {pronoun} is: \033[32;1m[verb]-")
    respuestas += 1
